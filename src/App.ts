...
export class App {
    ...
    #addGround() {
        ...
        // const ground = MeshBuilder.CreateGround("ground", { width: 10, height: 10, subdivisions: 10 }, this.scene);
        ...
        // groundMaterial.diffuseTexture = new Texture("./floor.png", this.scene);
        // ground.material = groundMaterial;

        const ground = MeshBuilder.CreateTiledGround("Tiled Ground", {
            xmin: -5,
            zmin: -5,
            xmax: 5,
            zmax: 5,
